...
>
    <div class="border-t border-zinc-800/90 bg-zinc-950/95 shadow-[0_-12px_30px_rgba(0,0,0,0.35)] backdrop-blur lg:border-t-0 lg:border-b lg:shadow-[0_12px_30px_rgba(0,0,0,0.25)]">
        ...
        <div class="grid grid-cols-5 px-2 py-2 lg:hidden" style="padding-bottom: max(0.5rem, env(safe-area-inset-bottom));">
            ...
            @auth
                <a href="{{ route('my-squads.index') }}" class="{{ request()->routeIs('my-squads.*') ? 'text-orange-500' : 'text-slate-400' }} flex flex-col items-center justify-center rounded-2xl px-2 py-2 text-[11px] font-semibold transition hover:text-orange-400">
                    <span class="mt-1">Squads</span>
                </a>
                ...
                <a href="{{ route('profile.edit') }}" class="{{ request()->routeIs('profile.*') ? 'text-orange-500' : 'text-slate-400' }} flex flex-col items-center justify-center rounded-2xl px-2 py-2 text-[11px] font-semibold transition hover:text-orange-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                        <path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5a18.683 18.683 0 0 1-7.812-1.7.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" />
                    </svg>
